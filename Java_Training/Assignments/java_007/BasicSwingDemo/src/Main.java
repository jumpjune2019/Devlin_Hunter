...
public class Main {
	...
	public static JFrame setFrameStuff(JFrame fr, int widt, int heigh, int onExi, String labe) {
		Lambda frame=(frm, width, height,onExit,label)->{
		...
		return frame.getValue(fr, widt, heigh, onExi, labe);
	}
