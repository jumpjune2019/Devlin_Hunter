...
public class Main {
	...
	public static void centerAndSizeJFrameOnScreen(JFrame fr) {
	...
	public static JFrame setFrameStuff(JFrame fr, int onExi, String labe) {
		...
		return frame.getValue(fr, onExi, labe);
	}
